...
import com.mangafrik.dto.admin.CreatorAccountDtos.CreateCreatorAccountResponse;
import com.mangafrik.services.email.EmailService;
import com.mangafrik.services.email.templates.CreatorCredentialsEmailTemplate;
...
public class CreatorAccountService {
	...
	private void maybeSendCredentialsEmail(CreateCreatorAccountResponse user, String tempPassword) {
		...
		String logoUrl = publicBaseUrl.replaceAll("/+$", "") + "/favicon.svg";
