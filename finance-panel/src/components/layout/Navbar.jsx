...
export default function Navbar() {
  ...
  const navLinks = [
    ...
    { label: t('nav.transactions', 'Transactions'), to: '/transactions' },
      ...
      <div className="navbar__inner container">
        <Link to="/overview" className="navbar__logo">
          <span className="navbar__logo-mark">
            <img className="navbar__logo-img" src="/finance-logo.png" alt="MangAfriq Finance" />
          </span>
        </Link>

        <nav className="navbar__nav" aria-label="Finance navigation">
          {navLinks.map((link) => (
        ...
        <div className="navbar__actions">
          ...
          <button className="navbar__burger" onClick={() => setMenuOpen((s) => !s)} aria-label="Menu" type="button">
