      ...
      >
          ...
          <View style={styles.hero}>
            ...
            <View style={[styles.heroInner, { paddingTop: 8 }]}>
              ...
              <View style={styles.heroMeta}>
                <Ionicons name="star" size={14} color={MangAfrik.rating} />
        ...
        <View style={styles.section}>
          ...
          {loadingLatest || !latest ? (
            <Text style={{ color: MangAfrik.textMuted, fontSize: 14 }}>Chargement…</Text>
          ) : (
        ...
        <View style={styles.section}>
          <View style={styles.sidebarBlock}>
            <View style={styles.sidebarHeader}>
              <Ionicons name="trending-up" size={18} color={MangAfrik.primary} />
                    ...
                    <Pressable style={({ pressed }) => [styles.rankedRow, pressed && { opacity: 0.92 }]}>
                      ...
                      <View style={styles.rankedInfo}>
                        ...
                        <View style={styles.rankedStats}>
                          <Ionicons name="star" size={12} color={MangAfrik.rating} />
          ...
          <View style={styles.sidebarBlock}>
            <View style={styles.sidebarHeader}>
              <Ionicons name="sparkles" size={18} color={MangAfrik.primary} />
